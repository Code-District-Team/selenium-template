...
class businesstrade:
    ...
    def addDeliveryOption(self):
        ...
        serviceDropdownOption = WebDriverWait(self.driver, 30).until(EC.element_to_be_clickable(tradelocators.serviceDropdown))
        serviceDropdownOption.click()
        regionDropdown = WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable(tradelocators.regionDropdown))
