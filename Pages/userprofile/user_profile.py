...
class Userprofile:
    ...
    def uploadProfileImage(self):
        editProfileImage = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.editProfileImage))
        ...
        time.sleep(3)
        saveBtn = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.saveBtn))
        saveBtn.click()

    def uploadcoverphoto(self):
        changeCoverPhoto = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.addCoverPhoto))
    ...
    def click_on_edit(self):
        editButton = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.editButton))
        editButton.click()
    def edit_profile_info(self):
        tagLine = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.tagLine))
        time.sleep(1)
        tagLine.send_keys(Keys.CONTROL, 'a')  # Select all text
        tagLine.send_keys(Keys.DELETE)
        time.sleep(1)
        tagLine.send_keys(UserprofileData.tagLine)
        aboutME = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.aboutMe))
        aboutME.send_keys(Keys.CONTROL, 'a')
        aboutME.send_keys(Keys.DELETE)
        time.sleep(1)
        aboutME.send_keys(UserprofileData.aboutMe)
        phoneNumber = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.phoneNumber))
        phoneNumber.send_keys(Keys.CONTROL, 'a')
        phoneNumber.send_keys(Keys.DELETE)
        time.sleep(1)
        phoneNumber.send_keys(UserprofileData.phoneNumber)
        websiteUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.webSiteInput))
        websiteUrl.send_keys(Keys.CONTROL, 'a')
        websiteUrl.send_keys(Keys.DELETE)
        time.sleep(1)
        websiteUrl.send_keys(UserprofileData.website)
        linkedinUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.linkedinInput))
        ...
        facebookUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.facebookInput))
        ...
        twitterUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.twitterInput))
        twitterUrl.send_keys(Keys.CONTROL, 'a')
        twitterUrl.send_keys(Keys.DELETE)
        time.sleep(1)
        twitterUrl.send_keys("https://twitter.com/AhmadWaleed")
        instagramUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.instagramInput))
        ...
        snapchatUrl = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.snapchatInput))
        ...
        updateButton = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.updateBtn))
        updateButton.click()
    def preview_profile(self):
        previewButton = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.previewButton))
        previewButton.click()
    def exit_preview(self):
        exitPreview = WebDriverWait(self.driver, 100).until(EC.element_to_be_clickable(profile_Locators.exitPreview))
        exitPreview.click()
