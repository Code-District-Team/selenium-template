...
class freelance_registration:
    ...
    def select_address(self):
        ...
        select_country = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable(registrationLocators.select_country))
        select_country.click()
        # time.sleep(1)
        state_dropdown = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable(registrationLocators.state_dropdown))
        state_dropdown.click()
        # time.sleep(1)
        select_state = WebDriverWait(self.driver, 20).until(EC.element_to_be_clickable(registrationLocators.select_state))
        select_state.click()
        # time.sleep(1)
